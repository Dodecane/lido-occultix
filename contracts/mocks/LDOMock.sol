...
/// @title LDOMock
///
/// @dev This is the contract for the mock Lido DAO token.
///
...
contract LDOMock is AccessControl, ERC20("Lido DAO", "LDO") {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, msg.sender), "LDOMock: only minter");
    _;
  }
