...
import {ILidoYearnVault} from "../interfaces/ILidoYearnVault.sol";

/// @title LidoVaultAdapter
///
/// @dev A vault adapter implementation which wraps LidoVault.
contract LidoVaultAdapter is IVaultAdapter {
  using FixedPointMath for FixedPointMath.FixedDecimal;
  using SafeERC20 for IDetailedERC20;
  using SafeMath for uint256;

  /// @dev The vault that the adapter is wrapping.
  ILidoYearnVault public vault;
  ...
  constructor(ILidoYearnVault _vault, address _admin) public {
    vault = _vault;
    admin = _admin;
    updateApproval();
